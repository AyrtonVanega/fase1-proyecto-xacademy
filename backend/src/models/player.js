...
const Player = sequelize.define("Player", {
  ...
  attacking_volleys: { type: DataTypes.INTEGER },
  skill_dribbling: { type: DataTypes.INTEGER },
  skill_curve: { type: DataTypes.INTEGER },
  ...
  movement_balance: { type: DataTypes.INTEGER },
  ...
  mentality_interceptions: { type: DataTypes.INTEGER },
  mentality_positioning: { type: DataTypes.INTEGER },
  mentality_vision: { type: DataTypes.INTEGER },
  mentality_penalties: { type: DataTypes.INTEGER },
  mentality_composure: { type: DataTypes.INTEGER },
  defending_marking: { type: DataTypes.INTEGER },
  ...
  player_traits: { type: DataTypes.STRING },
}, {
  tableName: "players",
  timestamps: false,
